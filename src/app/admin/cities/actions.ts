...
export async function createCity(data: CityInput) {
    const city = await prisma.city.create({
        data: {
            ...
            attractions: (data.attractions || []) as any,
            cafesAndFood: (data.cafesAndFood || []) as any,
            transportation: (data.transportation || {}) as any,
...
export async function updateCity(id: string, data: Partial<CityInput>) {
    const city = await prisma.city.update({
        ...
        data: {
            ...
            ...(data.attractions !== undefined && { attractions: data.attractions as any }),
            ...(data.cafesAndFood !== undefined && { cafesAndFood: data.cafesAndFood as any }),
            ...(data.transportation !== undefined && { transportation: data.transportation as any }),
